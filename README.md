## Ola! Me chamo Pablo, sou Desenvolvedor Web Full Stack!
- 🎓 Formado em <strong>Gestão da Tecnologia da Informação </strong> e Pós-graduado em <strong>Desenvolvimento Web Full Stack</strong>
- 💼 Atualmente trabalhando como Desenvolvedor Front-end (Angular)
- 💡 Meu objetivo como desenvolvedor é criar aplicações web estruturadas e performáticas, seguindo os melhores padrões.
